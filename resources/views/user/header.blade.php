            ...
            <ul class="navbar-nav">
                ...
                @auth
                        ...
                        <li class="nav-item">
                            ...
                            <x-dropdown-link class="nav-link text-danger" :href="route('profile.edit')">
                                {{ Auth::user()->name }}
                            </x-dropdown-link>
                        ...
                        <li class="nav-item">
                            <form method="POST" action="{{ route('logout') }}">
                                ...
                                <x-dropdown-link  class="nav-link text-danger" :href="route('logout')"
                                        onclick="event.preventDefault();
                                                    this.closest('form').submit();">
                                   <i class="fa fs-5 fa-sign-out text-danger"></i>{{ __('Logout') }}
                                </x-dropdown-link>
                            </form>
                        </li>
